...
<form role="form" action="modify" method="post">
	<input type='hidden' name='id' value="${plazaVO.id}">
				...
				<div class="box box-widget">
					<div class='box-header with-border'>
						<div class='user-block'>
							<span class='username'>
								<a href="/plaza/listTopic">[${plazaVO.plaza_title}]</a> -
								${plazaVO.title}
							</span>
							<span class='description'>
								<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${plazaVO.created_at}" />
							</span>
						</div>
						<!-- /.user-block -->
						<div class='box-tools'>
					...
					<div class="box box-body">
						...
						<span class='pull-right text-muted'>${plazaVO.cnt_like} likes
							- <small id='replycnt'>${plazaVO.cnt_comment}</small> comments</span>
					</div>
					<!-- /.box-body-->
...
<script>
	...
	$(".pagination").on("click", "li a", function(event) {
		...
		getPage("/p_replies/" + pno + "/" + replyPage);
...
<script>
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			formObj.attr("action", "/plaza/modify");
		...
		$("#removeBtn").on("click", function() {
			...
			formObj.attr("action", "/plaza/remove");
			formObj.submit();
		});

		$("#goListBtn").on("click", function() {
			formObj.attr("method", "get");
			formObj.attr("action", "/plaza/list");
			formObj.submit();
		});
		...
		$.getJSON("/plaza/getAttach/" + pno, function(list) {
			$(list).each(function() {
