...
<body class="login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="/resources/index2.html">Welcome to <b>TOWNTALK</b></a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			...
			<a href="http://localhost:8080/account/createAccount">I forgot my
				password</a><br> <a href="register.html" class="text-center">Register
				a new membership</a>
