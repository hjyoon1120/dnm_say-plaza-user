...
import com.dongnemon.util.MediaUtils;
import com.dongnemon.util.UploadFileUtils;
...
public class UploadController {
	...
	public ResponseEntity<String> uploadAjax(MultipartFile file) throws Exception {
		...
		logger.info("Using uploadAjax start !!@!!@!@!@!@");
	 ...
	 * public String uploadForm(MultipartFile file, Model model) throws
	 * Exception {
	 * 
	 * logger.info("originalName: " + file.getOriginalFilename());
	...
	public ResponseEntity<String> uploadForm(MultipartFile file) throws Exception {
		...
		logger.info("Using uploadForm start~~~~~~~");
		logger.info("originalName: " + file.getOriginalFilename());
		logger.info("size: " + file.getSize());
		logger.info("contentType: " + file.getContentType());
